  ...
  class Resource
    class Script < Chef::Resource::Execute
      ...
      def command(arg=nil)
        unless arg.nil?
          Chef::Log.warn
            "Specifying command on a script resource is a mistake, use the 'code' attribute, or the execute resource"
          Chef::Log.warn
            "This attribute is deprecated and must be fixed or this code will fail on Chef-13"
        end
